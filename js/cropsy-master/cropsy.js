...
;(function($) {
  $.fn.cropsy = function(options) {
    ...
    var $viewport = $('<div class="cropsy-container"><div class="cropsy-viewport"><div class="loading-indicator"></div><div class="cropsy-overlay"></div></div></div><div class="cropsy-zoom-slider"><div class="ui-slider-handle"></div></div><a href="javascript:void 0;" id="done">Done</a>');
